...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  //TODO INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu    , I, R(dest) = Mr(src1 + imm, 1));
  //TODO INSTPAT("??????? ????? ????? 001 ????? 00000 11", lh     , I, R(dest) = Mr(src1 + imm, 2));
  //TODO INSTPAT("??????? ????? ????? 101 ????? 00000 11", lhu    , I, R(dest) = Mr(src1 + imm, 2));
